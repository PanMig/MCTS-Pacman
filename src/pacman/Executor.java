...
{	
	...
	public static void main(String[] args)
	{
		...
		System.out.println("VISUAL : MCTS PACMAN vs Starter Ghosts");
		exec.runGame(new MctsPacman(), new StarterGhosts(), visual,10);
		...
		exec.runExperiment(new MctsPacman(), new Legacy(),numTrials);
